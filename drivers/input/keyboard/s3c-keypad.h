...
#if defined(CONFIG_MACH_SMDKC210)
...
int keypad_keycode[] = {
	...
	KEY_UP,  KEY_END,  27,  28,  29,  30,  31,  32, 
	KEY_REPLY,  KEY_BACK,  35,  36,  37,  38,  39,  40,
	KEY_DOWN,  KEY_VOLUMEUP,  43,  44,  45,  46,  47,  48,
	KEY_RIGHT,  KEY_MENU,  51,  52,  53,  54,  55,  56,
	KEY_LEFT,  KEY_VOLUMEDOWN, 59, 60, 61, 62, 63,  KEY_POWER,
};
#else
int keypad_keycode[] = {

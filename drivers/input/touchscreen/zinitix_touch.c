...
#elif defined(CONFIG_FB_S3C_LMS700JF04)
#define	SYSTEM_MAX_X_RESOLUTION	1024 
#define	SYSTEM_MAX_Y_RESOLUTION	600 
#else
#define	SYSTEM_MAX_X_RESOLUTION	800 
#define	SYSTEM_MAX_Y_RESOLUTION	480 
#endif
...
#define GPIO_TOUCH_IRQ  	IRQ_EINT(29)    // interrupt pin IRQ number
...
//1st b'd
//u32 BUTTON_MAPPING_KEY[SUPPORTED_BUTTON_NUM]	={KEY_SEARCH, KEY_MENU, KEY_HOME, KEY_BACK};  // qwerty

// 2nd b'd
u32 BUTTON_MAPPING_KEY[SUPPORTED_BUTTON_NUM]	={KEY_MENU, KEY_HOME, KEY_BACK, KEY_SEARCH};  // qwerty
...
static int zinitix_touch_probe(struct i2c_client *client, const struct i2c_device_id *i2c_id)
{
	...
	touch_dev->cap_info.Orientation = TOUCH_V_FLIP | TOUCH_XY_SWAP; //JNJ for Portrait
#if	RESET_CONTROL
	if(gpio_request(SYSTEM_RESET_PIN, "GPG2"))
	{

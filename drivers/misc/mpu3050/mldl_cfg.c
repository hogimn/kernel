...
#define ML_SKIP_CHECK 20
	...
	ERROR_CHECK(result);
printk("JNJ : gyro_resume() - result=%d\r\n",result);
	return result;
}
/*******************************************************************************
 *******************************************************************************
...
printk("JNJ : mpu3050_close() - res=%d\r\n",ret_result);
	return ret_result;
}

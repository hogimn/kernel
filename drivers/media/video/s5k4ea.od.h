 ...
 */
	static unsigned short s5k4ea_init_reg_short0[]={
	
	//=================================================================================================
	// * Name: S5K4EA EVT1.0 Initial Setfile 
...
,
	...
	static unsigned short s5k4ea_init_reg_short1[]={	
	// Start T&P part
...
,
	...
	static unsigned short s5k4ea_init_reg_short2[]={		
	//============================================================
...
static unsigned short s5k4ea_init_reg_short3[]={	
	//============================================================
...
static unsigned short s5k4ea_init_reg_short4[]={		
...
,
	...
	static unsigned short s5k4ea_init_reg_short4_2[]={		
...
,
	...
	static unsigned short s5k4ea_init_reg_short5[]={	
...
static unsigned short s5k4ea_init_reg_short6[]={		
...
static unsigned short s5k4ea_init_reg_short7[]={		
...
static unsigned short s5k4ea_init_reg_short8[]={	
...
// 3M capture
	{0x0028, 	0x7000},                                                             
	{0x002A, 	0x03D4},                                                             
	{0x0F12, 	0x0800}, //0A00 //0A20 //#define	REG_0TC_CCFG_usWidth  3M size(2048)                    
	{0x0F12, 	0x0600}, //0794 //0798 //define	REG_0TC_CCFG_usHeight          (1536)          
	{0x0F12, 	0x0005},	//#define	REG_0TC_CCFG_Format//0005=YUV, 0009=Jpeg          
	{0x002A, 	0x02AA},                                                             
	{0x0F12, 	0x0000},	//#REG_TC_GP_ActiveCapConfig    //capture config0:moto 1:TN 
	{0x002A, 	0x028E},                                                             
	{0x0F12, 	0x0001},	//#REG_TC_GP_NewConfigSync  //config º¯°æÀû¿ë               
	{0x002A, 	0x02AC},                                                             
	{0x0F12, 	0x0001},	//#REG_TC_GP_CapConfigChanged                               
	{0x002A, 	0x0282},                                                             
...
// ~3M capture
	...
	{0x0028,	0x7000},
	{0x002A,	0x02E0},
	{0x0F12,	0x0280},	//REG_0TC_PCFG_usWidth 1024
	{0x0F12,	0x01E0},  //REG_0TC_PCFG_usHeight 768
	
	{0x002A,	0x0282},
	{0x0F12,	0x0000},	//REG_TC_GP_EnableCapture  //Capture mode off
	{0x0F12,	0x0001},	//REG_TC_GP_EnableCaptureChanged
	{0x002A,	0x028E},
	{0x0F12,	0x0001},	//REG_TC_GP_NewConfigSync 0001 // configuration update
	{0x002A,	0x02A4},
	{0x0F12,	0x0001},	//REG_TC_GP_PrevConfigChanged 0001
	{0x002A,	0x027E},
	{0x0F12,	0x0001},	//REG_TC_GP_EnablePreview 0001
	{0x0F12,	0x0001},	//REG_TC_GP_EnablePreviewChanged 0001
*/
};

// capture preset
static unsigned short  s5k4ea_capture_preset_0[] = { 
...
static unsigned short s5k4ea_preview_preset_0[]={	
...
static unsigned short s5k4ea_movie_preset_0[]={	
	// Select and apply preview configuration
...
static unsigned short s5k4ea_preview_preset_800x480[]={	
	// Select and apply preview configuration
...
static unsigned short s5k4ea_capture_jpeg_2048x1536[]={	
	//This code is for 3M Full YUV Capture Mode.
...
#define S5K4EA_INIT_REGS0	\
		(sizeof(s5k4ea_init_reg_short0) / sizeof(s5k4ea_init_reg_short0[0]))

#define S5K4EA_INIT_REGS1	\
		(sizeof(s5k4ea_init_reg_short1) / sizeof(s5k4ea_init_reg_short1[0]))

#define S5K4EA_INIT_REGS2	\
		(sizeof(s5k4ea_init_reg_short2) / sizeof(s5k4ea_init_reg_short2[0]))

#define S5K4EA_INIT_REGS3	\
		(sizeof(s5k4ea_init_reg_short3) / sizeof(s5k4ea_init_reg_short3[0]))

#define S5K4EA_INIT_REGS4	\
		(sizeof(s5k4ea_init_reg_short4) / sizeof(s5k4ea_init_reg_short4[0]))

#define S5K4EA_INIT_REGS4_2	\
		(sizeof(s5k4ea_init_reg_short4_2) / sizeof(s5k4ea_init_reg_short4_2[0]))


#define S5K4EA_INIT_REGS5	\
		(sizeof(s5k4ea_init_reg_short5) / sizeof(s5k4ea_init_reg_short5[0]))

#define S5K4EA_INIT_REGS6	\
		(sizeof(s5k4ea_init_reg_short6) / sizeof(s5k4ea_init_reg_short6[0]))

#define S5K4EA_INIT_REGS7	\
		(sizeof(s5k4ea_init_reg_short7) / sizeof(s5k4ea_init_reg_short7[0]))

#define S5K4EA_INIT_REGS8	\
		(sizeof(s5k4ea_init_reg_short8) / sizeof(s5k4ea_init_reg_short8[0]))

#define S5K4EA_CAPTURE_PRESET_0	\
		(sizeof(s5k4ea_capture_preset_0) / sizeof(s5k4ea_capture_preset_0[0]))

#define S5K4EA_PREVIEW_PRESET_0	\
		(sizeof(s5k4ea_preview_preset_0) / sizeof(s5k4ea_preview_preset_0[0]))
		
#define S5K4EA_PREVIEW_PRESET_800x480	\
				(sizeof(s5k4ea_preview_preset_800x480) / sizeof(s5k4ea_preview_preset_800x480[0]))

#define S5K4EA_MOVIE_PRESET_0	\
			(sizeof(s5k4ea_movie_preset_0) / sizeof(s5k4ea_movie_preset_0[0]))

#define S5K4EA_CAPTURE_JPEG_2048x1536	\
		(sizeof(s5k4ea_capture_jpeg_2048x1536) / sizeof(s5k4ea_capture_jpeg_2048x1536[0]))
...
unsigned short s5k4ea_focus_auto[] = {
		0x0028, 0x7000,
...
unsigned short s5k4ea_zoom_fixed[][4] = {
		0x0028, 0x7000,
		0x002A, 0x0254, //REG_TC_AF_AfCmdParam
		0x0F12, 0x0000, //write lens position from 0000 to 00FF. 
				  //0000 means infinity and 00FF means macro
...
unsigned short s5k4ea_zoom_infinity[][4] = {
		0x0028, 0x7000,
		0x002A, 0x0254, //REG_TC_AF_AfCmdParam
		0x0F12, 0x0000, //write lens position from 0000 to 00FF. 
				  //0000 means infinity and 00FF means macro
...
unsigned short s5k4ea_zoom_macro[][4] = {
		0x0028, 0x7000,
		0x002A, 0x0254, //REG_TC_AF_AfCmdParam
		0x0F12, 0x0000, //write lens position from 0000 to 00FF. 
				  //0000 means infinity and 00FF means macro
...
unsigned short s5k4ea_focus_init[][4] = {
		0x0028, 0x7000,
		0x002A, 0x0254, //REG_TC_AF_AfCmdParam
		0x0F12, 0x0000, //write lens position from 0000 to 00FF. 
				  //0000 means infinity and 00FF means macro
...
#define S5K4EA_FOCUS	(sizeof(s5k4ea_focus_auto) / sizeof(s5k4ea_focus_auto[0]))

static const unsigned short *s5k4ea_regs_focus[] = {
	(unsigned short *)s5k4ea_focus_auto,
	(unsigned short *)s5k4ea_zoom_fixed,
	(unsigned short *)s5k4ea_zoom_infinity,
	(unsigned short *)s5k4ea_zoom_macro,
	(unsigned short *)s5k4ea_focus_init,
};
...
static unsigned short s5k4ea_wb_tungsten[] = {
//================================================================================================
...
static unsigned short s5k4ea_wb_fluorescent[] = {
//================================================================================================
...
static unsigned short s5k4ea_wb_sunny[] = {
//================================================================================================
...
static unsigned short s5k4ea_wb_cloudy[] = {
//================================================================================================
...
static unsigned short s5k4ea_wb_auto[] = {
...
/* Order of this array should be following the querymenu data */
static const unsigned short *s5k4ea_regs_wb_preset[] = {
	(unsigned short *)s5k4ea_wb_tungsten,
	(unsigned short *)s5k4ea_wb_fluorescent,
	(unsigned short *)s5k4ea_wb_sunny,
	(unsigned short *)s5k4ea_wb_cloudy,
	(unsigned short *)s5k4ea_wb_auto,
};
#define S5K4EA_WB_PRESET	(sizeof(s5k4ea_wb_auto) / sizeof(s5k4ea_wb_auto[0]))
...
static unsigned short s5k4ea_color_none[] = {
	0x0028 ,0x7000,	// set page
	0x002A ,0x021E,	// set address
	0x0F12 ,0x0000,	// No effect
};

static unsigned short s5k4ea_color_sepia[] = {
	0x0028 ,0x7000,	// set page
	0x002A ,0x021E,	// set address
	0x0F12 ,0x0004,	// Sepia
};

static unsigned short s5k4ea_color_aqua[] = {
	0x0028 ,0x7000,	// set page
	0x002A ,0x021E,	// set address
	0x0F12 ,0x0005,	// Aqua
};

static unsigned short s5k4ea_color_monochrome[] = {
	0x0028 ,0x7000,	// set page
	0x002A ,0x021E,	// set address
	0x0F12 ,0x0001,	// Mono (Black & White)
};

static unsigned short s5k4ea_color_negative[] = {
	0x0028 ,0x7000,	// set page
	0x002A ,0x021E,	// set address
	0x0F12 ,0x0003,	// Color + Negative
};

static unsigned short s5k4ea_color_sketch[] = {
	0x0028 ,0x7000,	// set page
	0x002A ,0x021E,	// set address	
...
/* Order of this array should be following the querymenu data */
static const unsigned short *s5k4ea_regs_color_effect[] = {
	(unsigned short *)s5k4ea_color_none,
	(unsigned short *)s5k4ea_color_sepia,
	(unsigned short *)s5k4ea_color_aqua,
	(unsigned short *)s5k4ea_color_monochrome,
	(unsigned short *)s5k4ea_color_negative,
	(unsigned short *)s5k4ea_color_sketch,
};
#define S5K4EA_COLOR_FX	(sizeof(s5k4ea_color_none) / sizeof(s5k4ea_color_none[0]))

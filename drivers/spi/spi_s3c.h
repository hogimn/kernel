...
#if defined (CONFIG_CPU_S5PV210) || defined (CONFIG_CPU_S5PV310)
...
#define S3C_SPI_PA_SPI0 	S5PV310_PA_SPI0
#define S3C_SPI_PA_SPI1 	S5PV310_PA_SPI1
#define S3C_SPI_PA_SPI2 	S5PV310_PA_SPI2
#endif
...
#if defined(CONFIG_CPU_S5PV310)
#define GPNAME               S5PV310_GPB
#define GPIO_CLK_0           (0x2 << 0) // S5PV310_GPB(0)
#define GPIO_CS_0            (0x2 << 4) // S5PV310_GPB(1)
#define GPIO_MISO_0          (0x2 << 8) // S5PV310_GPB(2)
#define GPIO_MOSI_0          (0x2 << 12) // S5PV310_GPB(3)

#define GPIO_CLK_1           (0x2 << 16) // S5PV310_GPB(4)
#define GPIO_CS_1            (0x2 << 20)  // S5PV310_GPB(5)
#define GPIO_MISO_1          (0x2 << 24) // S5PV310_GPB(6)
#define GPIO_MOSI_1          (0x2 << 28) // S5PV310_GPB(7)

#define GPNAME_CNTRL_2	     S5PV310_GPC1
#define GPIO_CLK_2           (0x2 << 4) // S5PV310_GPC1(1)
#define GPIO_CS_2            (0x2 << 8) // S5PV310_GPC1(2)
#define GPIO_MISO_2          (0x2 << 12) // S5PV310_GPC1(3)
#define GPIO_MOSI_2          (0x2 << 16) // S5PV310_GPC1(4)
#endif

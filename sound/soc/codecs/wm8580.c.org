...
printk("JNJ : wm8580_paif_hw_params + \r\n");
...
printk("JNJ : wm8580_set_paif_dai_fmt + \r\n");
...
printk("JNJ : wm8580_set_dai_clkdiv + ,div_id=%d, div=%d\r\n",div_id,div);
	switch (div_id) {
	case WM8580_MCLK:
...
printk("JNJ : wm8580_digital_mute + , mute=%d\r\n",mute);
...
{
	u16 reg;
printk("JNJ : wm8580_set_bias_level + , level=%d\r\n",level);
	switch (level) {
